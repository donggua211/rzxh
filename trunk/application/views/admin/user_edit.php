...
<div id="main">
	<div id="main_body">
		...
		<form action="<?php echo site_url('admin/user/edit') ?>" method="post" name="addstaff">
				...
				<td>
					<select name="group_id">
						...
						<?php
							...
							{
								echo '<option value="'.$val['group_id'].'" '.((isset($user['group_id'])) ? ( ($val['group_id'] == $user['group_id']) ? 'SELECTED' : '' ) : '').'>'.$val['group_name'].'</option>';
							}
						?>
					</select>
				</td>
